...
//   Book(this.title, this.condition, this.price, this.negotiable);
...
//       'images_urls': (this.images.isNotEmpty) ? this.images : 'Emplty',
//     };
//   }
...
//             : Icon(Icons.book),
//             */
//         Image.network(this.images[0], width: 100, height: 100),
//         Text(
//           title,
//           style: TextStyle(
//             fontSize: 15,
