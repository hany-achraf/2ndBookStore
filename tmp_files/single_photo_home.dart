...
//               //   String image_url = await postImage(image);
//               //   _images_url.add(image_url);
//               // });
...
//               //List<String> imagesUrls = await postImages(_images);
//               var image_url = 'No Image URL';
//               image_url = await postImage(_images[0]);
...
// // Future<List<String>> postImages(List<Asset> imagesFiles) async {
// //   List<String> imagesUrls;
// //   imagesFiles.forEach((imageFile) async {
// //     var imageData = await imageFile.getByteData();
// //     String fileName = DateTime.now().millisecondsSinceEpoch.toString();
// //     StorageReference reference = storage.ref().child(fileName);
// //     StorageUploadTask uploadTask =
// //         reference.putData(imageData.buffer.asUint8List());
// //     StorageTaskSnapshot storageTaskSnapshot = await uploadTask.onComplete;
// //     imagesUrls.add(await storageTaskSnapshot.ref.getDownloadURL());
// //   });
